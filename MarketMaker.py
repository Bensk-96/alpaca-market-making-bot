...
async def MarketMakerBasic():
    ...
    AAPL = MarketMaker(dataclient=i, ordermanager=o, symbol="AAPL", margins=0.002, stop_loss = 0.005, max_position=5, trader_loop_sleep_time = 15, tp_loop_sleep_time= 5)
    AMZN = MarketMaker(dataclient=i, ordermanager=o, symbol="AMZN", margins=0.002, stop_loss = 0.005, max_position=6 , trader_loop_sleep_time = 15, tp_loop_sleep_time= 5)
    TSLA = MarketMaker(dataclient=i, ordermanager=o, symbol="TSLA", margins=0.002, stop_loss = 0.005, max_position=5, trader_loop_sleep_time = 15, tp_loop_sleep_time= 5)
    NVDA = MarketMaker(dataclient=i, ordermanager=o, symbol="NVDA", margins=0.002, stop_loss = 0.005, max_position=9, trader_loop_sleep_time = 15, tp_loop_sleep_time= 5)
    META = MarketMaker(dataclient=i, ordermanager=o, symbol="META", margins=0.002, stop_loss = 0.005, max_position=2, trader_loop_sleep_time = 15, tp_loop_sleep_time= 5)
    GOOGL = MarketMaker(dataclient=i, ordermanager=o, symbol="GOOGL", margins=0.002, stop_loss = 0.005, max_position=7, trader_loop_sleep_time = 15, tp_loop_sleep_time= 5)
    QCOM = MarketMaker(dataclient=i, ordermanager=o, symbol="QCOM", margins=0.002, stop_loss = 0.005, max_position=5, trader_loop_sleep_time = 15, tp_loop_sleep_time= 5)
    MSFT = MarketMaker(dataclient=i, ordermanager=o, symbol="MSFT", margins=0.002, stop_loss = 0.005, max_position=2, trader_loop_sleep_time = 15, tp_loop_sleep_time= 5)
    NFLX = MarketMaker(dataclient=i, ordermanager=o, symbol="NFLX", margins=0.002, stop_loss = 0.005, max_position=1, trader_loop_sleep_time = 15, tp_loop_sleep_time= 5)
