...
async def MarketMakerBasic():
    ...
    AAPL = MarketMaker(dataclient=i, ordermanager=o, symbol="AAPL", margins=0.002, max_position=5, trader_loop_sleep_time = 30, tp_loop_sleep_time= 5, price_type = MIDPRICE, order_type= ORDER_TYPE_DAY)
    AMZN = MarketMaker(dataclient=i, ordermanager=o, symbol="AMZN", margins=0.002, max_position=6 , trader_loop_sleep_time = 30, tp_loop_sleep_time= 5, price_type = MIDPRICE, order_type= ORDER_TYPE_DAY)
    TSLA = MarketMaker(dataclient=i, ordermanager=o, symbol="TSLA", margins=0.002, max_position=5, trader_loop_sleep_time = 30, tp_loop_sleep_time= 5, price_type = MIDPRICE, order_type= ORDER_TYPE_DAY)
    NVDA = MarketMaker(dataclient=i, ordermanager=o, symbol="NVDA", margins=0.002, max_position=9, trader_loop_sleep_time = 30, tp_loop_sleep_time= 5, price_type = MIDPRICE, order_type= ORDER_TYPE_DAY)
    META = MarketMaker(dataclient=i, ordermanager=o, symbol="META", margins=0.002, max_position=2, trader_loop_sleep_time = 30, tp_loop_sleep_time= 5, price_type = MIDPRICE, order_type= ORDER_TYPE_DAY)
    GOOGL = MarketMaker(dataclient=i, ordermanager=o, symbol="GOOGL", margins=0.002, max_position=7, trader_loop_sleep_time = 30, tp_loop_sleep_time= 5, price_type = MIDPRICE, order_type= ORDER_TYPE_DAY)
    QCOM = MarketMaker(dataclient=i, ordermanager=o, symbol="QCOM", margins=0.002, max_position=5, trader_loop_sleep_time = 30, tp_loop_sleep_time= 5, price_type = MIDPRICE, order_type= ORDER_TYPE_DAY)
    MSFT = MarketMaker(dataclient=i, ordermanager=o, symbol="MSFT", margins=0.002, max_position=2, trader_loop_sleep_time = 30, tp_loop_sleep_time= 5, price_type = MIDPRICE, order_type= ORDER_TYPE_DAY)
    NFLX = MarketMaker(dataclient=i, ordermanager=o, symbol="NFLX", margins=0.002, max_position=1, trader_loop_sleep_time = 30, tp_loop_sleep_time= 5, price_type = MIDPRICE, order_type= ORDER_TYPE_DAY)
