...
async def MM_basic():
    ...
    AAPL = MarketMaker(dataclient=i, ordermanager=o, symbol="AAPL", margins=0.003, max_position=5, trader_loop_sleep_time = 45, tp_loop_sleep_time= 15, price_type = WEIGHTEDPRICE, order_type= ORDER_TYPE_DAY)
    AMZN = MarketMaker(dataclient=i, ordermanager=o, symbol="AMZN", margins=0.003, max_position=6 , trader_loop_sleep_time = 45, tp_loop_sleep_time= 15, price_type = WEIGHTEDPRICE, order_type= ORDER_TYPE_DAY)
    TSLA = MarketMaker(dataclient=i, ordermanager=o, symbol="TSLA", margins=0.003, max_position=5, trader_loop_sleep_time = 45, tp_loop_sleep_time= 15, price_type = WEIGHTEDPRICE, order_type= ORDER_TYPE_DAY)
    NVDA = MarketMaker(dataclient=i, ordermanager=o, symbol="NVDA", margins=0.003, max_position=9, trader_loop_sleep_time = 45, tp_loop_sleep_time= 15, price_type = WEIGHTEDPRICE, order_type= ORDER_TYPE_DAY)
    META = MarketMaker(dataclient=i, ordermanager=o, symbol="META", margins=0.003, max_position=2, trader_loop_sleep_time = 45, tp_loop_sleep_time= 15, price_type = WEIGHTEDPRICE, order_type= ORDER_TYPE_DAY)
    GOOGL = MarketMaker(dataclient=i, ordermanager=o, symbol="GOOGL", margins=0.003, max_position=7, trader_loop_sleep_time = 45, tp_loop_sleep_time= 15, price_type = WEIGHTEDPRICE, order_type= ORDER_TYPE_DAY)
    QCOM = MarketMaker(dataclient=i, ordermanager=o, symbol="QCOM", margins=0.003, max_position=5, trader_loop_sleep_time = 45, tp_loop_sleep_time= 15, price_type = WEIGHTEDPRICE, order_type= ORDER_TYPE_DAY)
